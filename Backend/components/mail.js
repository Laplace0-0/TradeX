  ...
  try {
    const info = await transporter.sendMail({
      ...
      html: `
        ...
        <a href="https://tradex-1.vercel.app//email_verification/${ token }" target="_blank" style="display: flex; text-align: center; padding: 12px 24px; border-radius: 4px; color: white; background: black; display: inline-block; margin: 0.5rem 0;">Confirm now</a><br>
